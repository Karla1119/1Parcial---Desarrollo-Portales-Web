document.addEventListener("DOMContentLoaded", function (){
    ...
    /*var cuandolosgatosnoestanlosratonesfiestahacenpormonton = true;
    let cuandoLosGatosNoEstanLosRatonesFiestaHacenPorMonton = true; //Nomenclatura Camello
    let cuando_los_gatos_no_estan_los_ratones_fiesta_hacen_por_monton = true;

    //Método Hungaro-Camello
    let Intedad = 18;
    let stredad = "diez y ocho";
    let boledad = true;*/